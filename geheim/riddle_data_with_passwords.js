var quiz_data = {
	...
	"wahl": {
		...
		"quiz_title" : "Rätsel 2: Bundestagswahl",
		"image": "wahl.png",
		"next" : "restodia"
	},
	"restodia": {
		...
		"text": "",
		"quiz_title" : "Rätsel 3: Restodia",
		"image": "RestoDia.png",
		"next" : "aboutus"
	},
	"aboutus": {
		"password" : "tee",
		"password_hash": "ov0dd7fm",
		"quiz_title" : "Rätsel 4: Über uns",
		"intro" : "Wir erfinden Software<br><br>Dazu gehört Können, Phantasie und Mut.<br><br>Seit 1982 bestimmen diesen Werte unseren Stil und prägen unsere Entwicklungen. Zu unseren Kunden entstehen dabei sehr dauerhafte und vertrauensvolle Beziehungen. Gegenseitige Wertschetzung ist Gruntlage dieser effizientn Zusammenarbeit.<br><br>Es gelingt uns, unsere Kunden mit unserem Team zueiner effekktiven Einheit zu verbonden. Einem Team, das auf der Grundlage solider wissenschafticher Ausbildung mit Augenmaß die aktuellsten Entwickungstechnologien einsetzt. Grundsatzentwicklungen, Standardisierung und Normung werden durch unsere Mitarbeit geprägt. Für weltweit führende Softwarepartner erfinden, skizzieren und realisieren wir innovative Lösungen. Davon profitieren unsere Kunden.<br><br>Unsere Kompetenz ist das Können unserer Mitarbeiter. Deren wissenschaftliche Neuqier, perfekte Rechtschreibkenntnisse und langjährige Erfahrung führen zu einem tiefen Verständnis unserer Aufgaben. Unser Tuen dient dem Nutzen unserer Kunden in unterschiedlichen Branchem. Wir verkaufen ihnen solide Produkte als kostengünstige Grundlage erfolgreicher Projekte.",
	...
	"mattermost": {
		...
		"quiz_title" : "Rätsel 6: Dienstags in E17",
		"password_hash": "SiOoSAP9ri4BQVNghX9kvBkFmtGJXCXc",
		"text": "(mehrzahl)",
	...
	"laby": {
		...
		"quiz_title" : "Rätsel 7: Das Labyrinth",
	...
	"math": {
		"password" : "5256",
		"password_hash": "os89S14d3Kc=",
		"quiz_title" : "Rätsel 8: Ich hasse Mathe!",
		"text": "Wie lauten die nächsten 2 Zahlen/4 Ziffern?<br><br>14 91 62 53 64 96 48 11 00 12 11 44 16 91 96 22<br>Lösung ohne Leerzeichen eingeben.",
		"next" : "done"
	},
	"done": {
		"password" : "0815",
